...
from python.decorators import time_it
...
@time_it
def find_largest_adjacent_product(grid, n):
    ...
    return max(h_max, v_max, r_diag_max, l_diag_max)


grid = string_grid_to_matrix(grid)
print(find_largest_adjacent_product(grid, n))